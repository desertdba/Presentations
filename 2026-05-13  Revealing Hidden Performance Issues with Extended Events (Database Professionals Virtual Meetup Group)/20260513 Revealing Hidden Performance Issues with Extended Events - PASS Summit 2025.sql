...
What if we have 100? That's not caught.
*/
DBCC FREEPROCCACHE;
GO
SELECT *  
...
/*
The magic number is...65 (in SQL Server 2022)
The magic number is...101 (in SQL Server 2025)
101 or more catches "Large Number of OR predicates"...
*/
DBCC FREEPROCCACHE;
GO
SELECT *  
...
OR [Views]  = 90 OR [Views]  = 91 OR [Views]  = 92 OR [Views]  = 93 
OR [Views]  = 94 OR [Views]  = 95 OR [Views]  = 96 OR [Views]  = 97 
OR [Views]  = 98 OR [Views]  = 99 OR [Views]  = 100;
...
This was NOT caught in SQL Server 2022
...but it IS caught in SQL Server 2025
...as TypeConvertPreventingSeek
*/
DBCC FREEPROCCACHE;
GO
...
This was NOT caught in SQL Server 2022
...but it IS caught in SQL Server 2025
...also as TypeConvertPreventingSeek
*/
SELECT ua.Id, ua.[Views]
FROM Users_antipattern ua
JOIN Users u
...
FROM dbo.Users AS u
ORDER BY u.Reputation
OPTION (MIN_GRANT_PERCENT = 0, MAX_GRANT_PERCENT = 1);

SELECT u.DisplayName, u.Reputation, u.AboutMe
FROM dbo.Users AS u
